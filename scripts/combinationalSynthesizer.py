...
def runTclScripts():
    ...
    status=os.system('yosys -c /home/sharan_math/gabor/{}/yosys_script_{}.tcl > /dev/null 2>&1'.format(EVOLUTION,str(INSTANCE)))
    #os.system('yosys -c ../{}/yosys_script_{}.tcl'.format(EVOLUTION,str(INSTANCE)))
    print('executing opensta script')
    status=os.system('sta /home/sharan_math/gabor/{}/opensta_script_{}.tcl > /dev/null 2>&1'.format(EVOLUTION,str(INSTANCE)))
...
def extractReports():
    ...
    report_file=open('/home/sharan_math/gabor/{}/{}_result.txt'.format(EVOLUTION,DESIGN),mode='r')
...
#read verilog design file
read_verilog /home/sharan_math/gabor/Design/4orarch3.v
#read_verilog ../adderCells/adderModules.v
...
#write netlist file
write_verilog -noattr /home/sharan_math/gabor/{}/{}_netlist.v

#store the area result in a file
tee -q -o /home/sharan_math/gabor/{}/{}_result.txt stat -liberty {}
...
""".format(LIBERTY_FILE,MODULE,FLATTEN,LIBERTY_FILE,LIBERTY_FILE,EVOLUTION,DESIGN,
           EVOLUTION,DESIGN,LIBERTY_FILE) 
...
#read the design file
read_verilog /home/sharan_math/gabor/{}/{}_netlist.v
...
#estimate power
report_power >> /home/sharan_math/gabor/{}/{}_result.txt
...
report_checks -path_delay max -path_group {{clock}} >> /home/sharan_math/gabor/{}/{}_result.txt
#----------------estimating critical path delay -------------------
