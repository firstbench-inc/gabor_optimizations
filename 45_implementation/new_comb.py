...
DESIGN='/home/sharan_math/gabor/Design/4orarch3.v'
...
def runTclScripts():
    ...
    #yosys script
    output_dir1 = f'/home/sharan_math/gabor/{EVOLUTION}/{INSTANCE}'
    print("out dir",output_dir1)
    os.makedirs(output_dir1, exist_ok=True)
    yosys_file=open('/home/sharan_math/gabor/{}/yosys_script_{}.tcl'.format(EVOLUTION,str(INSTANCE)),mode='w',encoding='utf-8')
    ...
    opensta_file=open('/home/sharan_math/gabor/{}/opensta_script_{}.tcl'.format(EVOLUTION,str(INSTANCE)),mode='w',encoding='utf-8')
    opensta_file.write(OPENSTA_SCRIPT)
    opensta_file.close()

    #executing scripts
    print('executing yosys script')
    status=os.system('yosys -c /home/sharan_math/gabor/{}/yosys_script_{}.tcl'.format(EVOLUTION,str(INSTANCE)))
    #os.system('yosys -c ../{}/yosys_script_{}.tcl'.format(EVOLUTION,str(INSTANCE)))
    print('executing opensta script')
    status=os.system('sta /home/sharan_math/gabor/{}/opensta_script_{}.tcl'.format(EVOLUTION,str(INSTANCE)))
...
def extractReports():
    ...
    report_file=open('/home/sharan_math/gabor/evolution/design1_result.txt'.format(EVOLUTION,DESIGN),mode='r')
...
read_verilog -sv /home/sharan_math/gabor/Design/new_design/convolution_block_45.sv
read_verilog -sv /home/sharan_math/gabor/Design/new_design/convolution_block_90.sv
read_verilog -sv /home/sharan_math/gabor/Design/new_design/convolution_block_135.sv
read_verilog -sv /home/sharan_math/gabor/Design/new_design/convolution_block_180.sv
read_verilog -sv /home/sharan_math/gabor/Design/new_design/fxp_mul.sv
read_verilog -sv /home/sharan_math/gabor/Design/new_design/ram.sv
...
clean
write_verilog -noattr /home/sharan_math/gabor/evolution/design1_netlist.v
tee -q -o /home/sharan_math/gabor/evolution/design1_result.txt stat -liberty /home/sharan_math/gabor/NANGATE_45nm_TT/NANGATE_45nm_TT.lib
...
read_verilog /home/sharan_math/gabor/evolution/design1_netlist.v
...
report_power >> /home/sharan_math/gabor/evolution/design1_result.txt
report_checks -path_delay max -path_group {clock} >> /home/sharan_math/gabor/evolution/design1_result.txt
